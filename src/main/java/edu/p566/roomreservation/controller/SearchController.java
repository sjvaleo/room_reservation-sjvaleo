...
public class SearchController {
  ...
  public String doSearch(@RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate date,
    ...
    // Normalize end (30-min minimum window if end missing or <= start)
    LocalTime realEnd = (end != null && end.isAfter(start)) ? end : start.plusMinutes(30);
